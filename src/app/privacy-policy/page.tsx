...
const PrivacyPolicyPage = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside ml-4 mb-6">
        <li>
          <strong>Google Analytics:</strong> Google Analytics is a web analytics service offered by Google that tracks and reports website
          traffic. Google uses the data collected to track and monitor the use of our Service. This data is shared with other Google
          services. Google may use the collected data to contextualise and personalise the ads of its own advertising network. You can
          opt-out of having made your activity on the Service available to Google Analytics by installing the Google Analytics opt-out
          browser add-on. The add-on prevents the Google Analytics JavaScript (ga.js, analytics.js and dc.js) from sharing information
          with Google Analytics about visits activity. For more information on the privacy practices of Google, please visit the Google
      ...
      <ul className="list-disc list-inside ml-4 mb-6">
        <li>
          ...
          <a href="https://stripe.com/us/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
      ...
      <p className="mb-4">
        We do not knowingly collect personally identifiable information from anyone under the age of 18. If you are a parent or guardian and
        you are aware that your Child has provided us with Personal Data, please contact us. If we become aware that we have collected
      ...
      <ul className="list-disc list-inside ml-4 mb-6 space-y-1">
        <li>By email: <a href="mailto:support@gobeyondmeasure.org" className="text-blue-600 hover:underline">support@gobeyondmeasure.org</a></li>
        <li>By visiting this page on our website: <Link href="/contact" className="text-blue-600 hover:underline">http://www.gobeyondmeasure.org/contact</Link></li>
        <li>By mail: 5001 California Avenue, Suite 214, Bakersfield, CA 93309</li>
      </ul>
    </div>
  );
};
